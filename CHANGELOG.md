...
### Changed
- `locals.tf:114` comment scrubbed of the `ipsupport.us` literal — replaced with the generic `<domain>.yaml` placeholder. Comment-only change, no behavioural impact.
